...
Claude Code plugin with 22 specialized subagents and 5 skills.
...
| [review-golang](claude/skills/review-golang/SKILL.md)             | Go code review on git-changed files using golang-pro agent with Context7 docs         |
| [update-golang-deps](claude/skills/update-golang-deps/SKILL.md)   | Update Go module deps using native `go` toolchain + govulncheck; handles v2+ paths    |
| [update-node-deps](claude/skills/update-node-deps/SKILL.md)       | Update Node.js deps (npm/pnpm/yarn/bun) using native commands with changelog + audit  |
